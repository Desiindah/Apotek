                ...
                <div class="tab-content" id="custom-tabs-four-tabContent">
                        ...
                        <tr>
                            ...
                            <td>
                                <b>Rp. <?= number_format($value ->total_bayar,0) ?></b><br>
                                  ...
                                  <span class="badge badge-primary">Sedang Dikemas</span><br>
                  ...
                  <table class="table">
                        ...
                        <tr>
                            ...
                            <td>
                              <?= $value ->no_resi ?> <br>
                              <button class="btn btn-warning btn-xs btn-flat" data-toggle="modal" data-target="#diterima<?= $value->id_transaksi?>">Diterima</button>
                            </td>
                        </tr>
                        <?php }?>
