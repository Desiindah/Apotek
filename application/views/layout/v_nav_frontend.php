  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      <a href="<?= base_url()?>" class="navbar-brand">
        <i class="fas fa-briefcase-medical text-info"></i>
        <span class="brand-text font-weight-light"><b>Apotek</b>RezaFarma</span>
      </a>
      ...
      <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
        ...
        <a class="nav-link" href="<?= base_url('pelanggan/login')?>">
          <span class="badge badge-text front-weight-light">Login/Register</span>
          <img src="<?= base_url('assets/icon/pelanggan.png')?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
              style="opacity: .8">
        </a>
        <?php }else{ ?>
        <a class="nav-link" data-toggle="dropdown" href="#">
          <span class="badge badge-text front-weight-light"><?= $this->session->userdata('nama_pelanggan') ?></span>
